...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        questions[4][0] = "In which memory a String is stored, when we create it using new operator?";
        questions[4][1] = "Stack";
        ...
        next.setBackground(new Color(161, 64, 100));
        next.setForeground(Color.WHITE);
        next.addActionListener(this);
        add(next);
        
        lifeline = new JButton("Cut to half");
        lifeline.setBounds(1000, 550, 200, 40);
        lifeline.setFont(new Font("Tahoma", Font.PLAIN, 22));
        lifeline.setBackground(new Color(161, 64, 100));
